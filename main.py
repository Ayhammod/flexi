...
def add_to_cart(product_id):
    ...
    if str(product_id) in session['cart']:
        ...
        print(
            f"Incremented quantity of product ID {product_id} in cart to {session['cart'][str(product_id)]}")  # Debug statement
    else:
        session['cart'][str(product_id)] = quantity  # Add product to cart
        print(f"Added product ID {product_id} to cart with quantity {quantity}")  # Debug statement
